...
function syncPackageConfig() {
  ...
  const rootPkgJson = JSON.parse(fs.readFileSync(rootPkgJsonFile, { encoding: 'utf-8' }));
  const corePkgJson = JSON.parse(fs.readFileSync(corePkgJsonFile, { encoding: 'utf-8' }));
